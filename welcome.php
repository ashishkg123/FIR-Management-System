...
<html>
   ...
   <body>
     <div class="container">
       ...
       <form name="form1" method="post" action="handle_req.php">
         ...
         <h5> Fill case_id for getting Witness-suspect: </h5>
         <div class="form-row">
           <div class="col">
 ...
 <h5> Last cases of a police </h5>
     ...
     <div class="form-row">
       <div class="col">
         <input type="text" name="critype" class="form-control" placeholder="Enter Crime Type...">
       </div>
     </div>
     <br>
     <div class="form-group row">
