<?php
  ...
  {
    $query = "SELECT Registration.Aadhar_Number, Registration.First_Name, Registration.Last_Name, Registration.Case_Id, Registration.Crime_Type, Registration.Date_Of_Crime, Registration.Place_Of_Crime, Registration.Phone_Number, Registration.Description
